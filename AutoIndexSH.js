/*
 * jecoding.blogspot.com
 * Re:NimeX Project
 */
var posts_no = 9999;
var post_rilis = true;
function post_latest(M) {
  document.write('<ul class="ep-item">');
  for (var I = 0; I < posts_no; I++) {
    ...
    x[1] = "Januari", x[2] = "Februari", x[3] = "Maret", x[4] = "April", x[5] = "May", x[6] = "Juni", x[7] = "Juli", x[8] = "Agustus", x[9] = "September", x[10] = "Oktober", x[11] = "November", x[12] = "Desember",
      document.write('<li class="ep-right">'), document.write('<div class="ep-list"><a href="' + j + '" target ="_top">' + E + "</a></div>"), 1 == post_rilis && document.write('<span class="eps-date">' + K + " " + x[parseInt(J, 10)] + " " + H + "</span>");
    var G = "",
      D = 0;
    document.write("</li>")
  }
